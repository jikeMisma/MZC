...
if(!$member_id=is_login($link)){
    skip('login.php', 'error', '请登录后设置个人头像!') ;
}
...
if(isset($_POST['submit'])){
    $save_upload='uploads/'.date('Y/m/d');
    
    $upload=upload($save_upload, '8M', 'photo');
...
<body>
	<div id="main">
		...
		<div>
			<h3>原头像：</h3>
			<img  style="width:160px;" src="<?php if($data_member['photo']!=''){echo $data_member['photo'];}else{echo 'style/mzc.jpg';}?>" />
			<br />
			最佳图片尺寸：180*180
		</div>
