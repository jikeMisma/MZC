<?php
function vcode($width=120,$height=40,$fontSize=36,$countElement=4,$countPixel=100,$countLine=4){
   ...
   // imagerectangle($img,0,0,$width-1,$height-1,$colorBorder);
    ...
    imagettftext($img,$fontSize,rand(-2,5),rand(5,15),rand(30,35),$colorString,'font/ManyGifts.ttf',$string);
    imagejpeg($img);
    imagedestroy($img);
