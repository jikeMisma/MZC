...
//nl2br()函数用于将用户输入的换行在展示的时候原封不懂的显示出来
...
<div id="main" class="auto">
	<div class="wrap1">
		...
		$page_size=5;
		$page=page($count_reply, $page_size,3);
		echo $page['html'];
		?>
		</div>
		...
		<div class="left">
			<div class="face">
				<a target="_blank" href="">
					<img width=120px; src="<?php if($data_content['photo']!=''){echo $data_content['photo'];}else{echo 'style/mzc.jpg';}?>" />
				</a>
			</div>
			<div class="name">
	...
	<?php }?>
	<?php 
	$query="select sm.name,sr.member_id,sr.quote_id,sm.photo,sr.time,sr.id,sr.content from sfk_reply sr,sfk_member sm where sr.member_id=sm.id and sr.content_id={$_GET['id']}  {$page['limit']}";
	...
	<div class="wrapContent">
		<div class="left">
			<div class="face">
				<a target="_blank" href="">
					<img width=120px; src="<?php if($data_reply['photo']!=''){echo $data_reply['photo'];}else{echo 'style/mzc.jpg';}?>" />
				</a>
			</div>
			<div class="name">
