...
<div id="main">
	...
	<form method="post">
		<table class="au">
			<tr>
				<td>网站标题</td>
				<td><input name="title" type="text" value="<?php echo $data_infp['title']?>" /></td>
				<td>
					前台页面的标题
				</td>
			</tr>
			<tr>
				<td>关键字</td>
				<td><input name="keywords" type="text" value="<?php echo $data_infp['keywords']?> "/></td>
				<td>
					前台页面的关键字
				</td>
			</tr>
			<tr>
				<td>描述</td>
				<td>
					<textarea name="description"<?php echo $data_infp['description']?> ><?php echo $data_infp['description']?> </textarea>
				</td>
				<td>
					站点的描述
				</td>
