...
<div id="main">
	...
	<div class="explain">
		<ul>
			<li>|- 父版块(<?php echo $count_father_module?>)&emsp;   
				       子版块(<?php echo $count_son_module?>)&emsp;   
				       帖子(<?php echo $count_content?>) &emsp;
				       回复(<?php echo $count_reply?>) &emsp;
				       会员(<?php echo $count_member?>) &emsp;
				       管理员(<?php echo $count_manage?>)&emsp;
		   </li>
		</ul>
	</div>
	<div class="explain">
	...
	<div class="explain">
		<ul>
			...
			<li>|- 程序版本：sfkbbs V1.0.1 <a target="_blank" href="http://wx.xshopwork.com">[查看最新版本]</a></li>
			<li>|- 程序作者：马志成  QQ:2889479657</li>
			<li>|- 网站：<a target="_blank" href="http://wx.xshopwork.com">http://wx.xshopwork.com/</a></li>
		</ul>
	</div>
</div>
